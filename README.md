...
Linux-native lab workspace for image, vision, visual-feature, and reranking experiments for SocioProphet services.

## Role in the Holmes lab family

`imagelab` is the first governed pilot lab for the Holmes vision-intelligence stack. It emits a `functional-service.v1` manifest that can be consumed by:

- `SocioProphet/holmes` as the vision-intelligence product surface;
