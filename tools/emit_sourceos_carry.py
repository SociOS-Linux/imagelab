...
def main() -> int:
    ...
    carry = {
        ...
        "carryId": "urn:srcos:model-carry:functional-service:imagelab-holmes-pilot",
        "displayName": "ImageLab Holmes Pilot Carry Profile",
        "service": {
            "id": service["id"],
            "ownerRepository": service["ownerRepository"],
            "function": manifest["function"],
            "manifestRef": "SociOS-Linux/imagelab:manifests/functional-service.json"
        },
        "sourceos": {
        ...
        "runtime": {
            ...
            "launchProfileRef": "urn:srcos:launch-profile:imagelab-holmes-pilot:disabled-v0",
        ...
        "evidence": {
            ...
            "smokeReceiptRef": "SociOS-Linux/imagelab:evidence/smoke-receipt.example.json"
        },
        "integrations": {
